...
export default function Chatbot() {
  ...
  // Dummy local FAQ responses (you can add more)
  const FAQ = {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 bg-indigo-600 text-white p-4 rounded-full shadow-lg hover:bg-indigo-700 transition z-50"
      >
        💬
      </button>
